...
const thisScriptPath = `core/ExpressApp.js`;
...
class ExpressApp {
  ...
  _useHelmet = () => {
    try {
      ...
      console.error(`Error while <_useHelmet> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
  ...
  _useNocache = () => {
    try {
      ...
      console.error(`Error while <_useNocache> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
  ...
  _useCors = () => {
    try {
      ...
      console.error(`Error while <_useCors> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
  ...
  _useJSON = () => {
    try {
      ...
      console.error(`Error while <_useJSON> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    }
  };
  ...
  _useCookie = () => {
    try {
      ...
      console.error(`Error while <_useCookie> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
  ...
  _start = () => {
    try {
      ...
      console.error(`Error while <_start> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
  ...
  _handleErrors = () => {
    try {
      ...
      console.error(`Error while <_handleErrors> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
  ...
  _useGracefullShutdown = () => {
    try {
      ...
      console.error(`Error while <_useGracefullShutdown> in class <${this.constructor.name}> in script <${thisScriptPath}>:`, error?.message);
      throw error;
    };
  };
};
